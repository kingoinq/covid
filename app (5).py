...
# Different blue shades for non-Mexico bars
BLUE_SHADES = [
    "#1e3a5f",
    "#1d4ed8",
    "#2563eb",
...
findings = [
    ("Key Finding 1",
     "Before COVID arrived, Mexico already had one of the highest diabetes rates in the group. "
     "This meant millions of people were already at serious risk the moment the virus began to spread."),
    ("Key Finding 2",
     "More people died per million in Mexico than in Brazil, Colombia, and Argentina — "
     "countries with similar economies. The virus hit harder here than it needed to."),
    ("Key Finding 3",
     "By the time Mexico's vaccination campaign gained speed, the worst waves had already come and gone. "
     "The protection arrived after the damage was done."),
    ("Key Finding 4",
     "Chile — a country at a similar income level — lost far fewer lives. "
     "That tells us the outcomes in Mexico were not unavoidable. Better preparation makes a real difference."),
]
